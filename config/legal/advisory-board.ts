...
export const advisoryBoardMembers: AdvisoryMember[] = [
  ...
  },
  {
    ...
    expertise: 'Clinical Decision Support & Health Data Science',
    bio: 'Prof. Marchetti develops and evaluates clinical decision support systems with a focus on integrating AI into existing clinical workflows while maintaining patient safety and clinician trust.',
    email: 'elena.marchetti@unibo.it',
    avatar: '',
    socialLinks: {
  ...
  },
  {
    ...
    expertise: 'Fairness, Equity & AI in Low-Resource Settings',
    bio: 'Dr. Owusu investigates AI fairness and equity in healthcare, particularly for underrepresented populations and low-resource clinical environments across sub-Saharan Africa.',
    email: 'jowusu@ug.edu.gh',
    avatar: '',
    socialLinks: {
      linkedin: 'https://www.linkedin.com/in/james-owusu/',
  ...
  },
  {
    ...
    expertise: 'Uncertainty Quantification & Explainability',
    bio: 'Dr. Tanaka works on formal methods for uncertainty quantification and explainability in deep learning models, with applications in medical diagnosis and safety-critical autonomous systems.',
    email: 'yuki.tanaka@riken.jp',
    avatar: '',
    socialLinks: {
  ...
  },
  {
    ...
    expertise: 'Healthcare Law, AI Regulation & Patient Rights',
    bio: 'Prof. Connolly advises on the legal and regulatory landscape for AI in healthcare, covering GDPR compliance, liability frameworks, and the ethical governance of AI-assisted clinical tools.',
    email: 's.connolly@tcd.ie',
    avatar: '',
    socialLinks: {
      linkedin: 'https://www.linkedin.com/in/sarah-connolly/',
